      ...
      <div className="preview-wrap">
        ...
        <div className={`quote-card image-mode-${model.imageMode || 'cutout'}`} ref={quoteRef}>
          ...
          <section className="quote-content">
            ...
            <div className="advisor"><div><span>EJECUTIVO DE VENTAS</span><strong>{advisor.name}</strong><small>Sucursal Bilbao · Providencia</small><small>Av. Francisco Bilbao 1147, Providencia</small></div><div className="advisor-contact"><b>{advisor.phone}</b><small>{advisor.email}</small>{clientPhone && <small>Cliente: {phoneText(clientPhone)}</small>}</div></div>
