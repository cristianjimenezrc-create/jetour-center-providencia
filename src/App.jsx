...
const models = [
  { slug: 'x50', name: 'X50', type: 'SUV Urbano', tone: 'white', tag: 'Ciudad' },
  { slug: 'x70-plus', name: 'X70 PLUS', type: 'SUV Familiar', tone: 'graphite', tag: 'Familia' },
  { slug: 'dashing', name: 'DASHING', type: 'SUV Deportivo', tone: 'red', tag: 'Diseño' },
  { slug: 't1', name: 'T1', type: 'SUV Adventure', tone: 'green', tag: 'Adventure' },
  { slug: 't2', name: 'T2', type: 'Off Road Premium', tone: 'black', tag: 'Premium' }
]

const benefits = [
  { title: 'Diseño', text: 'Diseño internacional con líneas modernas.', icon: '☆' },
  { title: 'Tecnología', text: 'Pantallas panorámicas, Apple CarPlay, Android Auto, cámaras 360° y ADAS según versión.', icon: '▣' },
  { title: 'Seguridad', text: 'Airbags, ESP, asistencias a la conducción y estructura reforzada según versión.', icon: '◇' },
  { title: 'Garantía', text: 'Respaldo de marca y atención directa en Guillermo Morales Bilbao.', icon: '✺' }
]
  ...
  return (
    <header className="nav">
      ...
      <div className="nav-actions">
        ...
        <a className="wsp-mini" href={wsp()} target="_blank" rel="noreferrer">☎</a>
  ...
  return (
    <motion.article className="model-card" initial={{ opacity: 0, y: 22 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.05 }}>
      ...
      <div className="model-copy">
        ...
        <a href={wsp(`Hola Cristián, quiero información del Jetour ${model.name}.`)} target="_blank" rel="noreferrer">Ver modelo →</a>
      </div>
    </motion.article>
  )
}
    ...
    <main>
      <section className="hero" id="inicio">
        ...
        <motion.div className="hero-content" initial={{ opacity: 0, y: 26 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
          ...
          <div className="hero-actions">
            ...
            <a className="btn light" href={wsp('Hola Cristián, quiero agendar un test drive Jetour.')} target="_blank" rel="noreferrer">▦ Agendar Test Drive</a>
          </div>
        </motion.div>
      </section>
      ...
      <section className="cinematic">
        <div>
          ...
          <button aria-label="Ver experiencia">→</button>
        </div>
      </section>
      ...
      <section className="finance-test" id="financiamiento">
        <div className="finance-panel">
          ...
          <div className="finance-options">
            <article><div className="big-symbol">▤</div><h3>Crédito</h3><p>Opciones de financiamiento y evaluación según perfil.</p><strong>Hasta 84 meses</strong></article>
            <article><div className="big-symbol">◉</div><h3>Compra inteligente</h3><ul><li>Bonos</li><li>Toma tu usado</li><li>Leasing</li></ul></article>
          </div>
        </div>
      ...
      <section className="location" id="contacto">
        ...
        <div className="dealer-info">
          ...
          <p>⌖ Av. Francisco Bilbao 2326, Providencia, Santiago</p>
          <p>◷ Lunes a viernes 09:00 – 19:00 hrs · Sábado 10:00 – 14:00 hrs</p>
          <p>☎ +56 9 4505 5463</p>
          <p>✉ cristianjimenezrc@gmail.com</p>
  ...
  return (
    <>
      ...
      <footer>
        ...
        <div className="social"><span>IG</span><span>YT</span><span>TT</span></div>
