...
const v = ({ code, name, price, smartPrice, conventionalPrice, motor, hp, transmission, traction = '4x2', features, source, quoteImages }) => ({
  code, name, price, smartPrice, conventionalPrice, motor, hp, transmission, traction, features, source, quoteImages
})
...
export const modelData = [
  {
    ...
    quoteImages: [IMG.x50, IMG.x50Secondary], imageMode: 'cutout', accent: '#b98a3a', price: 12490000, smartPrice: 9490000,
    ...
    versions: [
      v({ code: 'BX501', name: '1.5L MT LUX', price: 12490000, smartPrice: 9490000, conventionalPrice: 9990000, motor: '1.5L', hp: 145, transmission: '5MT', quoteImages: [IMG.x50White, IMG.x50Secondary], features: ['2 airbags', 'Sensor estacionamiento trasero', 'Radio touch 12,8”', 'Smart Key', 'Control crucero', 'Llantas 18”'], source: 'https://jetourchile.cl/w/x50' }),
      v({ code: 'BX503', name: '1.5L MT LUX BICOLOR', price: 12790000, smartPrice: 9790000, conventionalPrice: 10290000, motor: '1.5L', hp: 145, transmission: '5MT', quoteImages: [IMG.x50White, IMG.x50Secondary], features: ['2 airbags', 'Carrocería bicolor', 'Sensor estacionamiento trasero', 'Radio touch 12,8”', 'Smart Key', 'Llantas 18”'], source: 'https://jetourchile.cl/w/x50' }),
      v({ code: 'BX502', name: '1.5T 6DCT TURBO LUX', price: 15490000, smartPrice: 12690000, conventionalPrice: 13090000, motor: '1.5T', hp: 145, transmission: '6DCT', quoteImages: [IMG.x50Black, IMG.x50Secondary], features: ['4 airbags', 'Sensor estacionamiento trasero', 'Cámara panorámica 360°', 'Sunroof panorámico', 'Radio touch 12,8”', 'Modos Eco/Normal/Sport'], source: 'https://jetourchile.cl/w/x50' }),
      v({ code: 'BX504', name: '1.5T 6DCT TURBO LUX BICOLOR', price: 15790000, smartPrice: 12990000, conventionalPrice: 13390000, motor: '1.5T', hp: 145, transmission: '6DCT', quoteImages: [IMG.x50Black, IMG.x50Secondary], features: ['4 airbags', 'Carrocería bicolor', 'Cámara panorámica 360°', 'Sunroof panorámico', 'Radio touch 12,8”', 'Modos Eco/Normal/Sport'], source: 'https://jetourchile.cl/w/x50' })
    ]
  },
  {
    slug: 'dashing', name: 'Dashing', type: 'SUV deportivo', tag: 'Diseño', img: IMG.dashing,
    quoteImages: [IMG.dashing, IMG.dashingSecondary], imageMode: 'cutout', accent: '#b98a3a', price: 16490000, smartPrice: 12490000,
    ...
    versions: [
      v({ code: 'BD01', name: '6MT 1.5L TURBO SPECIAL EDITION FL', price: 16490000, smartPrice: 12490000, conventionalPrice: 12890000, motor: '1.5T', hp: 145, transmission: '6MT', quoteImages: [IMG.dashingSecondary, IMG.dashing], features: ['2 airbags', 'Sensor de proximidad trasero', 'Radio touch 12,8”', 'Smart Key + botón de encendido', 'Control crucero', 'Neumáticos 235/60 R18'], source: 'https://jetourchile.cl/w/dashing' }),
      v({ code: 'BD02', name: '1.5L 6MT TURBO LUX FL', price: 17490000, smartPrice: 13990000, conventionalPrice: 14390000, motor: '1.5T', hp: 145, transmission: '6MT', quoteImages: [IMG.dashingRed, IMG.dashing], features: ['4 airbags', 'Sensor de proximidad trasero', 'Cámara panorámica 360°', 'Radio touch 12,8”', 'Smart Key + botón de encendido', 'Neumáticos 235/55 R19'], source: 'https://jetourchile.cl/w/dashing' }),
      v({ code: 'BD03', name: '6DCT 1.5L TURBO SPECIAL EDITION FL', price: 18490000, smartPrice: 14490000, conventionalPrice: 14890000, motor: '1.5T', hp: 145, transmission: '6DCT', quoteImages: [IMG.dashingBlue, IMG.dashing], features: ['4 airbags', 'Sensor de proximidad trasero', 'Encendido remoto', 'Radio touch 12,8”', 'Modos Eco/Sport', 'Neumáticos 235/60 R18'], source: 'https://jetourchile.cl/w/dashing' }),
      v({ code: 'BD04', name: '6DCT 1.5L TURBO LUX', price: 19490000, smartPrice: 15990000, conventionalPrice: 16390000, motor: '1.5T', hp: 145, transmission: '6DCT', quoteImages: [IMG.dashingGray, IMG.dashing], features: ['6 airbags', 'Cámara panorámica 540°', 'Sensor de lluvia', 'Advertencia de colisión frontal y lateral', 'Portalón eléctrico regulable'], source: 'https://jetourchile.cl/w/dashing' }),
      v({ code: 'BD05', name: '7DCT 1.6L TURBO GDI LIMITED', price: 21990000, smartPrice: 17990000, conventionalPrice: 18390000, motor: '1.6T GDI', hp: 188, transmission: '7DCT', quoteImages: [IMG.dashingTechGray, IMG.dashing], features: ['6 airbags', 'Sensores delanteros y traseros', 'Cámara panorámica 540°', 'Sistema de seguridad ADAS', 'Control crucero adaptativo', 'Climatizador dual automático'], source: 'https://jetourchile.cl/w/dashing' })
    ]
  },
  {
    slug: 'x70', name: 'X70', type: 'SUV familiar', tag: 'Espacio', img: IMG.x70,
    quoteImages: [IMG.x70, IMG.x70Secondary], imageMode: 'photo', accent: '#9b6d2a', price: 17490000, smartPrice: 12490000,
    ...
    versions: [
      v({ code: 'BX701', name: '1.5L 6MT TURBO FL', price: 17490000, smartPrice: 12490000, conventionalPrice: 12890000, motor: '1.5T', hp: 145, transmission: '6MT', quoteImages: [IMG.x70Black, IMG.x70Secondary], features: ['6 airbags', 'Cámara de retroceso', 'Sensor de proximidad trasero', 'Monitor presión de neumáticos', 'Sunroof panorámico', 'Radio touch 10,25”'], source: 'https://jetourchile.cl/w/x70' }),
      v({ code: 'BX702', name: '1.5L 6DCT TURBO FL', price: 19490000, smartPrice: 14490000, conventionalPrice: 14890000, motor: '1.5T', hp: 145, transmission: '6DCT', quoteImages: [IMG.x70White, IMG.x70Secondary], features: ['6 airbags', 'Cámara de retroceso', 'Sensores delanteros y traseros', 'Portalón trasero eléctrico', 'Sunroof panorámico', 'Modos Eco/Sport'], source: 'https://jetourchile.cl/w/x70' })
    ]
  },
  {
    slug: 'x70-plus', name: 'X70 Plus', type: 'SUV familiar premium', tag: 'Familia', img: IMG.x70Plus,
    quoteImages: [IMG.x70Plus, IMG.x70PlusSecondary], imageMode: 'cutout', accent: '#9b6d2a', price: 20990000, smartPrice: 15990000,
    ...
    versions: [
      v({ code: 'BX705', name: '1.5T 6DCT FL', price: 20990000, smartPrice: 15990000, conventionalPrice: 16390000, motor: '1.5T', hp: 145, transmission: '6DCT', quoteImages: [IMG.x70PlusSecondary, IMG.x70Plus], features: ['4 airbags', 'Cámara panorámica 360°', 'Advertencia cambio de carril', 'Asistencia electrónica de frenado', 'Climatizador dual', 'Sunroof panorámico'], source: 'https://jetourchile.cl/w/x70-plus' }),
      v({ code: 'BX706', name: '1.6L GDI 7DCT LUX FL', price: 22490000, smartPrice: 16990000, conventionalPrice: 17390000, motor: '1.6T GDI', hp: 188, transmission: '7DCT', quoteImages: [IMG.x70PlusBlue, IMG.x70Plus], features: ['6 airbags', 'Sensor de proximidad trasero', 'Cámara panorámica 360°', 'Sensor de lluvia', 'Carga inalámbrica', 'Purificador de aire'], source: 'https://jetourchile.cl/w/x70-plus' })
    ]
  },
  {
    slug: 'x90-plus', name: 'X90 Plus', type: 'SUV familiar premium', tag: 'Premium', img: IMG.x90Plus,
    quoteImages: [IMG.x90Plus, IMG.x90PlusSecondary], imageMode: 'cutout', accent: '#9b6d2a', price: 27490000, smartPrice: 23490000,
    ...
    versions: [
      v({ code: 'BX901', name: '2.0T GDI 7DCT', price: 27490000, smartPrice: 23490000, conventionalPrice: 23990000, motor: '2.0T GDI', hp: 241, transmission: '7DCT', quoteImages: [IMG.x90Plus, IMG.x90PlusSecondary], features: ['6 airbags', 'Cámara panorámica 360°', 'Sistema de seguridad ADAS', 'Control crucero adaptativo', 'Climatizador dual + aire 3ª fila', 'Sunroof panorámico'], source: 'https://jetourchile.cl/w/x90-plus' })
    ]
  },
  {
    slug: 't1', name: 'T1', type: 'SUV adventure', tag: 'Adventure', img: IMG.t1,
    quoteImages: [IMG.t1, IMG.t1Secondary], imageMode: 'cutout', accent: '#8b6a38', price: 22990000, smartPrice: 18490000,
    ...
    versions: [
      v({ code: 'BT101', name: '1.5T 7DCT LUXURY', price: 22990000, smartPrice: 18490000, conventionalPrice: 18990000, motor: '1.5T', hp: 167, transmission: '7DCT', traction: '4x2', quoteImages: [IMG.t1Gray, IMG.t1Secondary], features: ['6 airbags', '3 modos de conducción', 'Freno electrónico con AutoHold', 'Monitor presión de neumáticos', 'Neumáticos 235/65 R18', 'Distancia entre ejes 2.800 mm'], source: 'https://jetourchile.cl/w/t1' }),
      v({ code: 'BT103', name: '1.5T 7DCT LUXURY MATE', price: 23490000, smartPrice: 18990000, conventionalPrice: 19490000, motor: '1.5T', hp: 167, transmission: '7DCT', traction: '4x2', quoteImages: [IMG.t1Gray, IMG.t1Secondary], features: ['6 airbags', 'Terminación pintura mate', '3 modos de conducción', 'Freno electrónico con AutoHold', 'Monitor presión de neumáticos', 'Neumáticos 235/65 R18'], source: 'https://jetourchile.cl/w/t1' }),
      v({ code: 'BT102', name: '2.0T 8AT XWD LIMITED', price: 26990000, smartPrice: 21990000, conventionalPrice: 22490000, motor: '2.0T', hp: 241, transmission: '8AT', traction: 'XWD', quoteImages: [IMG.t1Blue, IMG.t1], features: ['Sistema de seguridad ADAS', 'Control crucero adaptativo', 'Frenado de emergencia AEB', 'Monitoreo punto ciego', 'Cámara 360° + chasis 180°', 'Asientos eléctricos ventilados y calefaccionados'], source: 'https://jetourchile.cl/w/t1' }),
      v({ code: 'BT104', name: '2.0T 8AT XWD LIMITED MATE', price: 27490000, smartPrice: 22490000, conventionalPrice: 22990000, motor: '2.0T', hp: 241, transmission: '8AT', traction: 'XWD', quoteImages: [IMG.t1Blue, IMG.t1], features: ['Terminación pintura mate', 'Sistema de seguridad ADAS', 'Control crucero adaptativo', 'Frenado de emergencia AEB', 'Monitoreo punto ciego', 'Cámara 360° + chasis 180°'], source: 'https://jetourchile.cl/w/t1' })
    ]
  },
  {
    slug: 't2', name: 'T2', type: 'SUV off road premium', tag: 'Premium', img: IMG.t2,
    quoteImages: [IMG.t2, IMG.t2Secondary], imageMode: 'cutout', accent: '#8b6a38', price: 29990000, smartPrice: 26990000,
    ...
    versions: [
      v({ code: 'BT201', name: '2.0T GDI AWD 7DCT LIMITED', price: 29990000, smartPrice: 26990000, conventionalPrice: 27490000, motor: '2.0T GDI', hp: 241, transmission: '7DCT', traction: 'AWD', quoteImages: [IMG.t2Secondary, IMG.t2], features: ['Tracción inteligente AWD', 'Sistema de seguridad ADAS', 'Cámara 360° + chasis transparente 180°', 'Pantalla 15,6” con CarPlay/Android Auto', 'Climatizador dual', 'Sunroof panorámico'], source: 'https://jetourchile.cl/w/t2' }),
      v({ code: 'BT202', name: '2.0T GDI AWD 7DCT LIMITED MATE', price: 30490000, smartPrice: 27490000, conventionalPrice: 27990000, motor: '2.0T GDI', hp: 241, transmission: '7DCT', traction: 'AWD', quoteImages: [IMG.t2Secondary, IMG.t2], features: ['Terminación pintura mate', 'Tracción inteligente AWD', 'Sistema de seguridad ADAS', 'Cámara 360° + chasis transparente 180°', 'Pantalla 15,6”', 'Sunroof panorámico'], source: 'https://jetourchile.cl/w/t2' })
    ]
  },
  {
    slug: 't1-phev', name: 'T1 PHEV', type: 'SUV híbrido enchufable', tag: 'PHEV', img: IMG.t1Phev,
    quoteImages: [IMG.t1Phev], imageMode: 'cutout', accent: '#477a68', price: 29990000, smartPrice: 27990000,
    ...
    versions: [
      v({ code: 'PT101', name: '1.5T PHEV LIMITED', price: 29990000, smartPrice: 27990000, conventionalPrice: 28990000, motor: '1.5T PHEV', hp: 341, transmission: 'DHT', quoteImages: [IMG.t1PhevGreen, IMG.t1Phev], features: ['6 airbags', 'Sistema de seguridad ADAS', 'Control crucero adaptativo', 'Cámara 540°', 'Asistente mantenimiento de carril', 'Autonomía combinada +1.000 km'], source: 'https://jetourchile.cl/w/t1-phev' }),
      v({ code: 'PT102', name: '1.5T PHEV LIMITED MATE', price: 30490000, smartPrice: 28490000, conventionalPrice: 29490000, motor: '1.5T PHEV', hp: 341, transmission: 'DHT', quoteImages: [IMG.t1PhevGreen, IMG.t1Phev], features: ['Terminación pintura mate', '6 airbags', 'Sistema de seguridad ADAS', 'Control crucero adaptativo', 'Cámara 540°', 'Autonomía combinada +1.000 km'], source: 'https://jetourchile.cl/w/t1-phev' })
    ]
  },
  {
    slug: 't2-phev', name: 'T2 PHEV', type: 'SUV híbrido enchufable', tag: 'PHEV', img: IMG.t2Phev,
    quoteImages: [IMG.t2Phev, IMG.t2PhevSecondary], imageMode: 'cutout', accent: '#477a68', price: 36990000, smartPrice: 33490000,
    ...
    versions: [
      v({ code: 'PT201', name: '1.5T PHEV LIMITED', price: 36990000, smartPrice: 33490000, conventionalPrice: 34490000, motor: '1.5T PHEV', hp: 375, transmission: 'DHT', quoteImages: [IMG.t2PhevSecondary, IMG.t2Phev], features: ['6 airbags', 'Sistema de seguridad ADAS', 'Control crucero adaptativo', 'Cámara 540°', 'Asistente mantenimiento de carril', 'Autonomía hasta 1.000 km'], source: 'https://jetourchile.cl/w/t2-phev' }),
      v({ code: 'PT202', name: '1.5T PHEV LIMITED MATE', price: 37490000, smartPrice: 33990000, conventionalPrice: 34990000, motor: '1.5T PHEV', hp: 375, transmission: 'DHT', quoteImages: [IMG.t2PhevSecondary, IMG.t2Phev], features: ['Terminación pintura mate', '6 airbags', 'Sistema de seguridad ADAS', 'Control crucero adaptativo', 'Cámara 540°', 'Autonomía hasta 1.000 km'], source: 'https://jetourchile.cl/w/t2-phev' })
    ]
  }
]
